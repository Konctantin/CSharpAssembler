...
namespace SharpAssembler.Core
{
	...
	/// call <see cref="ObjectFile.AddNewSection"/>.
	/// </remarks>
	[Serializable]
	public sealed class Section : Collection<Constructable>,
		IIdentifiable, IAnnotatable, IObjectFileVisitable
	{
		...
		/// </summary>
		private List<IEmittable> emittables = null;
		/// <summary>
		...
		/// identifier does not start with a digit. Use the <see cref="ObjectFile.AddNewSection"/> method to ensure
		/// that the identifier is valid for the file format.</para>
		...
		/// <see cref="ObjectFile.AddNewSection"/> method to ensure that the identifier is valid for the file
		/// format.</para>
		/// <para>Some identifiers have a special meaning in certain implementations and file formats.</para>
		/// </remarks>
