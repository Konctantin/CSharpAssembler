...
using SharpAssembler.BinFormat;
...
namespace SharpAssembler.x86.Tests.Instructions
{
	...
	public class InstructionTestBase
	{
		...
		/// </summary>
		/// <param name="instruction">The <see cref="Instruction"/> instance to test.</param>
		/// <param name="expected">The expected result.</param>
		public void Assert16BitInstruction(Instruction instruction, byte[] expected)
		{
		...
		/// </summary>
		/// <param name="instruction">The <see cref="Instruction"/> instance to test.</param>
		public void Assert16BitInstructionFails(Instruction instruction)
		{
		...
		/// <param name="instruction">The <see cref="Instruction"/> instance to test.</param>
		/// <param name="expected">The expected result.</param>
		public void Assert32BitInstruction(Instruction instruction, byte[] expected)
		{
		...
		/// </summary>
		/// <param name="instruction">The <see cref="Instruction"/> instance to test.</param>
		public void Assert32BitInstructionFails(Instruction instruction)
		{
		...
		/// <param name="instruction">The <see cref="Instruction"/> instance to test.</param>
		/// <param name="expected">The expected result.</param>
		public void Assert64BitInstruction(Instruction instruction, byte[] expected)
		{
		...
		/// </summary>
		/// <param name="instruction">The <see cref="Instruction"/> instance to test.</param>
		public void Assert64BitInstructionFails(Instruction instruction)
		{
		...
		/// <param name="instruction">The <see cref="Instruction"/> instance to test.</param>
		/// <param name="expected">The expected result.</param>
		private void AssertXBitInstruction(Instruction instruction, byte[] expected, DataSize mode)
		{
			#region Contract
			if (instruction == null)
		...
		/// </summary>
		/// <param name="instruction">The <see cref="Instruction"/> instance to test.</param>
		private void AssertXBitInstructionFails(Instruction instruction, DataSize mode)
		{
			#region Contract
			if (instruction == null)
				throw new ArgumentNullException("instruction");
		...
		/// </summary>
		/// <param name="instruction">The <see cref="Instruction"/> to assemble.</param>
		...
		/// </exception>
		private byte[] Assemble(Instruction instruction, DataSize mode)
		{
			byte[] actual = null;
			BinObjectFile objectFile = new BinObjectFile("test", new Architecture(CpuType.AmdBulldozer, mode));
		...
		/// <param name="expected">The expected result.</param>
		public void AssertInstruction(Instruction instruction, DataSize mode, byte[] expected)
		{
			#region Contract
			if (instruction == null)
				throw new ArgumentNullException("instruction");
		...
		/// <param name="instruction">The <see cref="Instruction"/> instance to test.</param>
		/// <param name="mode">The mode (16-bit, 32-bit or 64-bit) to use.</param>
		public void AssertInstructionFail(Instruction instruction, DataSize mode)
		{
			#region Contract
			if (instruction == null)
				throw new ArgumentNullException("instruction");
		...
		/// <param name="mode">The mode (16-bit, 32-bit or 64-bit) to use.</param>
		public void AssertInstruction(Instruction instruction, string nasmInstruction, DataSize mode)
		{
			#region Contract
			if (instruction == null)
				throw new ArgumentNullException("instruction");
		...
		/// <param name="nasmInstruction">The NASM string representation of the same instruction.</param>
		/// <param name="mode">The mode (16-bit, 32-bit or 64-bit) to use.</param>
		public void AssertInstructionFail(Instruction instruction, string nasmInstruction, DataSize mode)
		{
			#region Contract
			if (instruction == null)
				throw new ArgumentNullException("instruction");
		...
		private Tuple<byte[], byte[]> AssembleInstruction(Instruction instruction, string nasmInstruction, DataSize mode)
		{
			#region Contract
			if (!Enum.IsDefined(typeof(DataSize), mode))
				throw new InvalidEnumArgumentException("mode", (int)mode, typeof(DataSize));
