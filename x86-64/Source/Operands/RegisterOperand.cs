		...
		IRegisterOrMemoryOperand, ISourceOperand
	{
		...
		internal override bool IsMatch(Instruction.OperandDescriptor descriptor)
		{
			switch (descriptor.OperandType)
			{
				...
				case Instruction.OperandType.FixedRegister:
		...
		internal override void Adjust(Instruction.OperandDescriptor descriptor)
		{
			...
			if (descriptor.OperandEncoding == Instruction.OperandEncoding.OpcodeAdd)
				this.Encoding = OperandEncoding.AddToOpcode;
			else if (descriptor.OperandType == Instruction.OperandType.FixedRegister)
