...
namespace SharpAssembler.x86.Operands
{
	...
	internal interface IConstructableOperand : IOperand
	{
		...
		[Pure]
		bool IsMatch(Instruction.OperandDescriptor descriptor);
		...
		/// </remarks>
		void Adjust(Instruction.OperandDescriptor descriptor);
	}
	...
	namespace Contracts
	{
		...
		abstract class IConstructableOperandContract : IConstructableOperand
		{
			...
			public bool IsMatch(Instruction.OperandDescriptor descriptor)
			{
			...
			public void Adjust(Instruction.OperandDescriptor descriptor)
			{
				Contract.Requires<ArgumentNullException>(descriptor != null);
