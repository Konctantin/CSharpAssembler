...
namespace SharpAssembler.x86
{
	...
	public sealed partial class EncodedInstruction : IEmittable
	{
		...
		/// <see cref="SharpAssembler.x86.EncodedInstruction.PrefixLockRepeat.None"/> to specify no prefix.
		/// The default is <see cref="SharpAssembler.x86.EncodedInstruction.PrefixLockRepeat.None"/>.</value>
		...
		/// <see cref="SharpAssembler.x86.EncodedInstruction.PrefixSegmentBranch.None"/> to specify no prefix.
		/// The default is <see cref="SharpAssembler.x86.EncodedInstruction.PrefixSegmentBranch.None"/>.</value>
		...
		/// <see cref="SharpAssembler.x86.EncodedInstruction.PrefixAddressSizeOverride.None"/> to specify no prefix.
		/// The default is <see cref="SharpAssembler.x86.EncodedInstruction.PrefixAddressSizeOverride.None"/>.</value>
		...
		/// <see cref="SharpAssembler.x86.EncodedInstruction.PrefixOperandSizeOverride.None"/> to specify no prefix.
		/// The default is <see cref="SharpAssembler.x86.EncodedInstruction.PrefixOperandSizeOverride.None"/>.</value>
		...
		/// <see cref="SharpAssembler.Core.DataSize.None"/>.</value>
		...
		/// The default is <see cref="SharpAssembler.Core.DataSize.None"/>.</value>
