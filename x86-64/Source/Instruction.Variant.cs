...
namespace SharpAssembler.x86
{
	partial class Instruction
	{
		...
		internal sealed class InstructionVariant
		{
			#region Constructors
			/// <summary>
			/// Initializes a new instance of the <see cref="Instruction.InstructionVariant"/> class.
			/// </summary>
		...
		internal void Encode(Context context, IList<Operand> operands)
		{
			...
			/// <see cref="Instruction.InstructionVariant"/>.
			/// </summary>
			...
			/// <see cref="Instruction.InstructionVariant"/>; otherwise, <see langword="false"/>.</returns>
			...
			public bool IsValid(Architecture architecture)
			{
				#region Contract
