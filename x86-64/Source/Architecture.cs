...
namespace SharpAssembler.x86
{
	...
	public class Architecture : IArchitecture
	{
		...
		/// </summary>
		/// <remarks>
		/// The <see cref="CpuType"/> is set to <see cref="SharpAssembler.x86.CpuType.IntelSandyBridge"/>.
		/// </remarks>
		public Architecture()
		...
		public Architecture(CpuFeatures features)
		...
		/// The <see cref="Features"/> are set according to the selected <paramref name="type"/>.
		/// </remarks>
		public Architecture(CpuType type, DataSize addressingMode)
		...
		/// <param name="features">The features of the CPU.</param>
		/// <param name="addressingMode">The addressing mode to use.</param>
		public Architecture(CpuFeatures features, DataSize addressingMode)
		...
		/// </remarks>
		public Architecture(CpuType type, CpuFeatures features, DataSize addressingMode, bool ripRelative = false)
		{
			#region Contract
			Contract.Requires<InvalidEnumArgumentException>(Enum.IsDefined(typeof(DataSize), addressingMode));
			Contract.Requires<ArgumentException>(addressingMode == DataSize.None || IsValidAddressSize(type, addressingMode),
		...
		/// <returns>A <see cref="DataSize"/> other than <see cref="SharpAssembler.Core.DataSize.None"/>.</returns>
		[Pure]
